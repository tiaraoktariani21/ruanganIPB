...
?>
	...
	<div class="container" style="margin-top:20px">
		...
		<hr>
		<a href="index.php?page=tambah_mhs"><button class="btn btn-primary right">Tambah Data</button></a>
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>'.$data['Jenis_Gedung'].'</td>
							<td>'.$data['Tanggal'].'</td>
							<td>'.$data['Transaksi'].'</td>

							<td>
								<a href="index.php?page=edit_mhs&NIM='.$data['NIM'].'" class="btn btn-success btn-sm">Edit</a>
